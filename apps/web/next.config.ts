...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      ...
      { protocol: "https", hostname: "www.lospumas.com.ar", pathname: "/**" },
      { protocol: "https", hostname: "lospumas.com.ar", pathname: "/**" },
      { protocol: "https", hostname: "wallabies.rugby", pathname: "/**" },
      { protocol: "https", hostname: "www.rugby.com.au", pathname: "/**" },
      { protocol: "https", hostname: "rugby.com.au", pathname: "/**" },
      { protocol: "https", hostname: "www.allblacks.com", pathname: "/**" },
      { protocol: "https", hostname: "allblacks.com", pathname: "/**" },
      { protocol: "https", hostname: "images.allblacks.com", pathname: "/**" },
      { protocol: "https", hostname: "www.nzrugby.co.nz", pathname: "/**" },
      { protocol: "https", hostname: "nzrugby.co.nz", pathname: "/**" },
      { protocol: "https", hostname: "waratahs.rugby", pathname: "/**" },
      { protocol: "https", hostname: "reds.rugby", pathname: "/**" },
      { protocol: "https", hostname: "brumbies.rugby", pathname: "/**" },
