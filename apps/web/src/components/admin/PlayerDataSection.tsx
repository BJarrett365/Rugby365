...
import { PlayerAvailabilityPanel } from "@/components/admin/PlayerAvailabilityPanel";

export function PlayerDataSection({
  playerId,
  seasonRows,
}: {
  playerId: string;
  ...
  return (
    <div className="space-y-4 mb-4">
      <div className="cms-card">
        <h3 className="font-semibold m-0">Player data</h3>
        <p className="text-sm text-zinc-500 mt-1 mb-4">
          Public availability, season performance aggregates and match-by-match SDMS stats for this player.
        </p>

        <PlayerAvailabilityPanel playerId={playerId} embedded />
      </div>

      <div className="cms-card overflow-x-auto">
        <h4 className="font-semibold m-0">Performance by season</h4>
        <p className="text-sm text-zinc-500 mt-1 mb-4">
