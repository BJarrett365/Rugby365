...
export { scoringRulesForCompetitionSlug, DOMESTIC_SCORING_DEFAULT, rugbyChampionshipScoringRules } from "./competition-scoring-rules-catalog";
...
export async function getScoringRulesForCompetition(
  ...
  return scoringRulesForCompetitionSlug(competition.slug, competition.competitionType, seasonYear);
}
